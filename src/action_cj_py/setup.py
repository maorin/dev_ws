...
setup(
    ...
    entry_points={
        'console_scripts': [
            'fibonacci_action_server = action_cj_py.fibonacci_action_server:main',
            'fibonacci_action_client = action_cj_py.fibonacci_action_client:main',
        ],
    },
)
